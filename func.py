...
x1 = div(add(-b, exp(sub(exp(b,2), multi(multi(-4, a),c)), 0.5)), multi(2,a))# TODO: write a code to compute the first root of the quadratic equation
x2 = div(sub(-b, exp(sub(exp(b,2), multi(multi(-4, a),c)), 0.5)), multi(2,a)) # TODO: then do the same for the second root
